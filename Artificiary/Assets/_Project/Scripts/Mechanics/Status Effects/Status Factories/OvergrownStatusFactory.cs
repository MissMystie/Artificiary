...
namespace Mystie.ChemEngine
{
    ...
    public class OvergrownStatus : StatusEffect<OvergrownStatusData>
    {
        ...
        public override bool Apply()
        {
            ...
            {
                overgrownPFX = GameObject.Instantiate(data.overgrownPFX.gameObject, target.entity.Sprite.transform).GetComponent<ParticleSystemController>();
        ...
        public override void Expire()
        {
            if (phys != null)
            {
                ...
                if (!hasBloomed) phys.onCollision -= OnCollision;
            }

            target.transform.SetParent(null);

            if (bloomPFX != null) bloomPFX.Stop();
