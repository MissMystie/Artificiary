...
namespace Mystie.ChemEngine
{
    ...
    public class BurnStatus: StatusEffect<BurnStatusData>
    {
        ...
        public override bool Apply()
        {
            ...
            {
                burnPFX = GameObject.Instantiate(data.burnPFX.gameObject, target.entity.Sprite.transform).GetComponent<ParticleSystemController>();
            ...
            {
                burnProcPFX = GameObject.Instantiate(data.burnProcPFX.gameObject, target.entity.Sprite.transform).GetComponent<ParticleSystemController>();
                if (target.entity.Sprite != null) 
