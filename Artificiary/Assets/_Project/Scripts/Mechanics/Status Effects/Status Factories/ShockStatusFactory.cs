...
namespace Mystie.ChemEngine
{
    ...
    public class ShockStatus: StatusEffect<ShockStatusData>
    {
        ...
        public override bool Apply()
        {
            ...
            {
                shockPFX = GameObject.Instantiate(data.shockPFX.gameObject, target.entity.Sprite.transform).GetComponent<ParticleSystemController>();
            ...
            {
                shockProcPFX = GameObject.Instantiate(data.shockProcPFX.gameObject, target.entity.Sprite.transform).GetComponent<ParticleSystemController>();
        ...
        bool Spread()
        {
            ...
            Vector2 spreadArea = Vector2.one * data.spreadRadius;
            if (target.entity.Collider != null) {
                spreadArea += target.entity.Collider.bounds.size.xy();
            }

            Collider2D[] colliders = Physics2D.OverlapBoxAll(target.transform.position, spreadArea, 0);
